  ...
  return (
    <div className="py-16 text-center">
      ...
      {buttonText && onAddClick && (
        <div
          className="inline-block transform cursor-pointer rounded-lg bg-blue-600 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-blue-700 hover:shadow-xl"
          onClick={onAddClick}
        >
