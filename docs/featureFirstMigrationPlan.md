...
| **2** | **Classes** | Class cards/modals/forms; `ClassesWorkspace` / `EditClassModalRoot` |
| **3** | **Students** | Student cards, modals/menus/forms; `StudentsWorkspace` |
...
- `src/features/classes/ClassesWorkspace.tsx`, `ClassCardsGrid.tsx`, `EditClassModalRoot.tsx`
...
- `src/features/students/StudentsWorkspace.tsx`, `StudentCardsGrid.tsx`
